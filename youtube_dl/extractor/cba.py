...
class CBAIE(InfoExtractor):
    ...
    def _try_wp_api(self, video_id, api_key):
        api_posts_url = "https://cba.media/wp-json/wp/v2/posts/%s" % video_id
        api_media_url = "https://cba.media/wp-json/wp/v2/media?media_type=audio&parent=%s" % video_id
    ...
    def _try_preview_player(self, video_id):
        url = "https://cba.media/%s" % video_id
